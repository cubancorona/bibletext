...
// (owner decision, 2026-08-18): accidental closes while scrolling outweighed
...
func showAISettings(state *AppState) {
	...
	hint.TextSize = 11
	// A small, humble link home (owner's words), riding under the hint in the
	...
	// the accidental-dismiss-while-scrolling the owner kept hitting cannot
