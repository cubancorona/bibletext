...
// deliberate step (docs/NOTES_SCRAPBOOK.md).
//
...
// decode-only forever, for the owner's own dev links and the published
...
// present-with-zero-runs (empty, a real assertion — see docs/NOTES_SCRAPBOOK.md
// on the 'a' record).
