...
static int btaEnsureClass(JNIEnv *env, jobject ctx) {
	...
	// The shared-note sticker (full-screen reading, task #19): text, WHO line,
...
// with the real UTF-8 charset (refuter finding).
...
// this push it showed a lit span with nothing to say why (task #19). Leaving
