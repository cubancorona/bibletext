...
func TestProductIdentityRejectsMalformedFiles(t *testing.T) {
	...
	cases := map[string]string{
		...
		"ios min not a version": strings.Replace(good, `"iosMinimumOSVersion": "15.0"`, `"iosMinimumOSVersion": "fifteen"`, 1),
		"mac min empty":         strings.Replace(good, `"macMinimumOSVersion": "12.0"`, `"macMinimumOSVersion": ""`, 1),
	}
