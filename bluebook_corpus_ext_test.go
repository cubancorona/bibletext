...
func TestBluebookRule5CorpusExpanded(t *testing.T) {
	cases := []struct{ rule, src, in, want string }{
		...
		{"alter", "Bluebook Citation Help", "it has not [been] shown . . . that the requirement", "“[I]t has not [been] shown . . . that the requirement . . . .”"},
		...
		{"alter", "Legal Writing Launch  ", "individual [who] enters the premises without permission.", "“[I]ndividual [who] enters the premises without permission.”"},
		...
		{"alter", "Citing and Accessing U", "factors which are peculiarly within [agency] expertise", "“[F]actors which are peculiarly within [agency] expertise . . . .”"},
		{"alter", "Citing and Accessing U", "consciously and expressly adopt[] a general policy", "“[C]onsciously and expressly adopt[] a general policy . . . .”"},
		{"alter", "The Bluebook std ed Ru", "the judgment[] of the lower courts", "“[T]he judgment[] of the lower courts . . . .”"},
		...
		{"sic", "Legal Writing Launch  ", "principle [sic] objective.", "“[P]rinciple [sic] objective.”"},
		...
		{"sic", "The Maroonbook  The Un", "promote the possibility of lasting peach [sic].", "“[P]romote the possibility of lasting peach [sic].”"},
		...
		{"omit-middle", "Temple Law Review  D U", "are pleasant . . . and are prompt with their assignments.", "“[A]re pleasant . . . and are prompt with their assignments.”"},
		...
		{"omit-end", "Columbia Law School Wr", "duty of the judicial department . . . .", "“[D]uty of the judicial department . . . .”"},
		...
		{"nested", "LegalEase Citations Bl", "that Florida’s sentencing scheme in death penalty cases is unconstitutional because ‘[t]he Sixth Amendment requires a jury, not a judge, to find each fact necessary to impose a sentence of death.’", "“[T]hat Florida’s sentencing scheme in death penalty cases is unconstitutional because ‘[t]he Sixth Amendment requires a jury, not a judge, to find each fact necessary to impose a sentence of death.’”"},
		{"nested", "LegalEase Citations Bl", "jury's mere recommendation is not enough.", "“[J]ury's mere recommendation is not enough.”"},
		...
		{"nested", "Citing and Accessing U", "take Care that the Laws be faithfully executed", "“[T]ake Care that the Laws be faithfully executed . . . .”"},
		...
		{"emphasis-paren", "North Carolina Bar Ass", "is manifestly unsupported by reason, or so arbitrary that it could not have been the result of a reasoned decision.", "“[I]s manifestly unsupported by reason, or so arbitrary that it could not have been the result of a reasoned decision.”"},
		...
		{"block-inline", "LawProse Bryan A Garne", "the bane of many a brief and the affliction of many an appellate judge.", "“[T]he bane of many a brief and the affliction of many an appellate judge.”"},
	}
	for _, c := range cases {
