...
// The three raw benchmarks run every variant in one process because filesystem
// latency varies too widely across separate `go test` runs for a useful direct
// comparison.
