...
func TestBluebookQuotationRule5(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			"“David says about Him: ‘I saw the Lord always before me; because He is at my right hand, I will not be shaken.’”",
			"user-reported (IMG_0447): Acts 2:25 opens David's psalm citation, which closes in v28 — the inner single must be matched (Rule 5.1(b))",
		},
		{
...
// end to end (IMG_0446 / IMG_0447). Card A (Acts 2:25 alone) opens David's psalm
