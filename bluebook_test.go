...
func TestBluebookQuotationRule5(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			"“What is truth?” Pilate asked. And having said this, he told them, “I find no basis for a charge against Him.”",
			"user-reported (a screenshot): the share must be a balanced, well-formed quotation",
		},
		{
...
// TestBluebookEndOmissionPipeline is the a screenshot case end to end: John 18:38 (BSB),
