...
| `nativeNoteSticker` | false | Shared notes render as the Fyne banner above the pane (chips, notice path, hide/delete verbs) — the exact Win/Linux surface — instead of the native in-text sticker. |
