...
repository path, the Fyne apps directory points people at a module-path
install, and the module proxy and sum database record every tag from here on. A published tag is immutable.
