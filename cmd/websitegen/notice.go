...
func noticeNav(n noticeSpec) string {
	...
	// same translation two ways is talking past itself (owner request).
	//
...
// openInApp is the owner's "explicit open in app button … incorporated with the
...
// parallelSection is the owner's "option to view the parallel passage (with
