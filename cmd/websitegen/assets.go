...
.notex{
  position:absolute; top:.35rem; right:.4rem; background:none; border:0;
  padding:.15rem .35rem; cursor:pointer; color:var(--muted);
  font-size:1.2rem; line-height:1; font-family:var(--ui);
}
