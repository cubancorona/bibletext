...
// The results trail is CHROME, not content (owner, 2026-08-19: "the back to
...
//
// They also pin the owner's clarification of report B: the trail belongs to
...
func trailBarBudget(t *testing.T) float32 {
	...
	// THE ABSOLUTE BACKSTOP (refuter F1): the structural budget above follows
	...
	// the thing the owner said took too much space.
...
// Report B, clarified (owner, 2026-08-19): a search arrival shows the compact
