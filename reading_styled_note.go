...
type styledNote struct {
	...
	// Own marks YOUR note, drawn because you asked to see it. It decides one
...
// against the line above — 0pt above against 19pt below, which the owner saw at
...
func (r *styledPaneRenderer) buildNote() {
	...
	if p.note.Own {
		...
		// theme, which the sticker keeps deliberately small (owner: subtle).
