...
// ttsSupportedOnPlatform: Android's engine includes TextToSpeech read-aloud
// (android/BtAudio.java), so every chapter has an audio source. Read through
// the ttsSupported var seam (audio.go).
