...
//     the passage in half — the owner's rule, and the reason is the point:
//     "No breaking up the Word of God." (Whether it should open BELOW that
//     paragraph instead is TABLED and undecided — docs/NOTES_SCRAPBOOK.md.)
...
//	         docs/NOTES_SCRAPBOOK.md rather than pretended away. macOS also
