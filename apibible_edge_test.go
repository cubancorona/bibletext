...
func TestDecodeAPIBibleEdgeRangedMarker(t *testing.T) {
	...
	vs, err := decodeAPIBibleChapter(json.RawMessage(content), "Matthew", 5)
	if err != nil {
		t.Fatal(err)
	}
	if len(vs) != 1 {
...
func TestDecodeAPIBibleEdgeVerseGap(t *testing.T) {
	...
	vs, err := decodeAPIBibleChapter(json.RawMessage(content), "Acts", 8)
	if err != nil {
		t.Fatal(err)
	}
	if len(vs) != 2 {
...
func TestDecodeAPIBibleEdgeSuperscriptionNoLeak(t *testing.T) {
	...
	vs, err := decodeAPIBibleChapter(json.RawMessage(content), "Psalms", 23)
	if err != nil {
		t.Fatal(err)
	}
	if len(vs) != 1 {
...
func TestDecodeAPIBibleEdgeTitleOnlyChapter(t *testing.T) {
	...
	_, err := decodeAPIBibleChapter(json.RawMessage(content), "Psalms", 23)
	if err == nil {
...
func TestDecodeAPIBibleEdgeMarkerWithoutNumber(t *testing.T) {
	...
	vs, err := decodeAPIBibleChapter(json.RawMessage(content), "Matthew", 7)
	if err != nil {
		t.Fatal(err)
	}
	if len(vs) != 1 {
