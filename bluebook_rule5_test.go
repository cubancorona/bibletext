...
func TestBluebookRule5Corpus(t *testing.T) {
	cases := []struct{ rule, src, in, want string }{
		...
		{"nested-quotes", "synthetic fixture", "Fixture Writer wrote: \"In the sample essay, Fixture Essayist wrote, 'As Plato once said, \"Be kind, for everyone you meet is fighting a harder battle.\" This is the sample conclusion.' The fixture agrees.\"", "Fixture Writer wrote: \"In the sample essay, Fixture Essayist wrote, 'As Plato once said, \"Be kind, for everyone you meet is fighting a harder battle.\" This is the sample conclusion.' The fixture agrees.\""},
		...
		{"ellipsis-omission", "templelawreview.org", "staffers on the Temple Law Review are pleasant . . . . They . . . get along", "“[S]taffers on the Temple Law Review are pleasant . . . . They . . . get along . . . .”"},
		...
		{"bracket-alteration", "ubalt.edu", "[T]he drug-addled, intoxicated, 5'10\", 155 pound Johnson [c]ould have [performed] an athletic feat of nearly Olympic proportions [by moving] Klein from the bedroom doorway to the couch", "[T]he drug-addled, intoxicated, 5'10\", 155 pound Johnson [c]ould have [performed] an athletic feat of nearly Olympic proportions [by moving] Klein from the bedroom doorway to the couch . . . ."},
		...
		{"bracket-alteration", "michiganlawreview.org", "[C]ertain fundamental rights are \"deeply rooted in this Nation's history and tradition\"", "[C]ertain fundamental rights are \"deeply rooted in this Nation's history and tradition . . . .\""},
		...
		{"quiz", "testprepreview.com", "temps, or temporary workers.", "“[T]emps, or temporary workers.”"},
