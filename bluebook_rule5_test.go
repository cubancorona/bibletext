...
func TestBluebookRule5Corpus(t *testing.T) {
	cases := []struct{ rule, src, in, want string }{
		...
		{"nested-quotes", "grammarly.com", "[redacted-fixture-name] wrote: \"In his essay, Steven wrote, 'As Plato once said, \"Be kind, for everyone you meet is fighting a harder battle.\" This is how I feel.' I agree.\"", "[redacted-fixture-name] wrote: \"In his essay, Steven wrote, 'As Plato once said, \"Be kind, for everyone you meet is fighting a harder battle.\" This is how I feel.' I agree.\""},
