...
// S11a — the browser must hold a years-deep scrapbook (docs/NOTES_SCRAPBOOK.md,
...
func seedNoteStore(t *testing.T, count int) {
	...
	texts := []string{
		...
		"Remember what we talked about on the phone? This is the passage. Read the whole chapter when you get a quiet minute and tell me what you see in verse four.",
	}
