...
cd cmd/mobile
fyne package -os iossimulator --app-id io.github.cubancorona.bibletext
...
xcrun simctl launch booted io.github.cubancorona.bibletext

# Build a signed .ipa for a real device (paid Developer Program required):
fyne package -os ios --app-id io.github.cubancorona.bibletext \
