# Retired icon design (historical)

This directory holds the project's **first** app-icon design — a dove over an
open book on a dark field (`bibletext_icon.svg`, with 1024/120/60&nbsp;px
renders) — preserved as design history.
